...
m=23.25 # percentage of major elements
n=6.97 #percentage of dopant
...
atomsk cocrfeni_super.xsf -select random $n% Ni -substitute Ni Al al0p3cocrfeni_super.xsf cfg


# Apply mirror symmetry
atomsk al0p3cocrfeni_super.xsf -mirror 0 Y -wrap al0p3cocrfeni_mirror.xsf
# Merge the original super cell with the mirror supercell
atomsk --merge Y 2 al0p3cocrfeni_super.xsf al0p3cocrfeni_mirror.xsf al0p3cocrfeni_nanotwin.xsf cfg
