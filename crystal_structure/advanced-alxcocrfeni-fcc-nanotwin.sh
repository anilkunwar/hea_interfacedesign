...
m=22.22 # percentage of major elements
n=11.12 #percentage of dopant
...
atomsk cocrfeni_super.xsf -select random $n% Ni -substitute Ni Al al0p5cocrfeni_super.xsf cfg
